...
#  password.
#  Default: ''
c.NotebookApp.password = "argon2:$argon2id$v=19$m=10240,t=10,p=8$xvz0mi9pHX3lpKLqGdRBvA$Y8xqw2CEvwzORmkM9+bHOFgWHT/TmRewsfd4F7yqmJU"
...
#  Choices: any of ['sha224', 'sha384', 'blake2b', 'sha3_224', 'sha512', 'sha1', 'md5', 'sha3_384', 'sha3_512', 'sha3_256', 'sha256', 'blake2s']
#  Default: 'sha256'
